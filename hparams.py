...
voc_model_id = 'asvoice_aligner_melgan_google_newmodel_raw'
tts_model_id = 'asvoice_aligner_melgan_google_newmodel_tts'
...
tts_dropout = 0.5
language = 'de'
tts_cleaner_name = 'german_cleaners'
...
tts_schedule = [(10,  1e-4,  10_000,  32),   # progressive training schedule
